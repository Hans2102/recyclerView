...
public class Data_Adapter extends RecyclerView.Adapter<Data_Adapter.View_holder> {
    com.example.recyclerview.Data_model[] data_list;

    public Data_Adapter(com.example.recyclerview.Data_model[] data_list) {
    ...
    public void onBindViewHolder(@NonNull View_holder holder, int position) {
        com.example.recyclerview.Data_model data_model = data_list[position];
